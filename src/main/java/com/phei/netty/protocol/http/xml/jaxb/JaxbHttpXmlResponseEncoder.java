 ...
 *
 */
public class JaxbHttpXmlResponseEncoder extends AbstractJaxbHttpXmlEncoder<JaxbHttpXmlResponse> {
	 ...
	 */
	@Override
	protected void encode(ChannelHandlerContext ctx, JaxbHttpXmlResponse msg, List<Object> out) throws Exception {
