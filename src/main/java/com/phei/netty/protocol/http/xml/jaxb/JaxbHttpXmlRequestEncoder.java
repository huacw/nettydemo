 ...
 *
 */
public class JaxbHttpXmlRequestEncoder extends AbstractJaxbHttpXmlEncoder<JaxbHttpXmlRequest> {

	@Override
	protected void encode(ChannelHandlerContext ctx, JaxbHttpXmlRequest msg, List<Object> out) throws Exception {
